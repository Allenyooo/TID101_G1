    ...
    <div class="enter_body">
        <section class="enter_cut1">
            <div class="enter_cut1_open">
                <div class="cut1_door">
                    <img src="../assets/Image/enter/palace_door_L.png" class="cut1_door_L">
                    <img src="../assets/Image/enter/palace_door_R.png" class="cut1_door_R">
                </div>
            </div>
        </section>
        <section class="enter_emperor">
            <img src="../assets/Image/enter/emperor_stand_whole.png" alt="come on" class="standup">
            <img src="../assets/Image/enter/hand.png" alt="touch" class="hand">
            <div class="enter_table">
                <div class="enter_highlight">
                    <img src="../assets/Image/enter/highlight_1.png" alt="bling bling" class="hl_1">
                    <img src="../assets/Image/enter/highlight_2.png" alt="bling bling" class="hl_2">
                    <img src="../assets/Image/enter/highlight_3.png" alt="bling bling" class="hl_3">
                    <img src="../assets/Image/enter/highlight_4.png" alt="bling bling" class="hl_4">
                    <img src="../assets/Image/enter/highlight_5.png" alt="bling bling" class="hl_5">
                    <img src="../assets/Image/enter/highlight_6.png" alt="bling bling" class="hl_6">
                    <img src="../assets/Image/enter/highlight_7.png" alt="bling bling" class="hl_7">
                </div>
            </div>
