            ...
            <ul class="member_container">
                ...
                <li>
                    ...
                    <div class="password-input">
                        ...
                        <input type="password" id="container_password" :value="detail.PASSWORD" disabled v-if="eyeClose" />

                        <input type="text" name="password" id="container_password" v-model="detail.PASSWORD" readonly v-else />
