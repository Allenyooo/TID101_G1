    ...
    <nav>
        ...
        <button id="btnMenu" class="c-btnMenu" aria-label="梨花殿" @click="show=!show">
            ...
            <span class="c-btnMenu_text">
                <span id="Menu" class="text" :class="{'show': !show}">Menu</span> <!-- 展開時顯示文字-->
                <span id="Close" class="text" :class="{'show': show}">Close</span> <!--未展開時顯示文字-->
                <img  class="deco deco1" :class="{'show' : !show}" src="/src/assets/Image/navAndFooter/hamburger/deco1.png" alt="#">
            </span>
            <!--漢堡-->
...
<style lang="css" scoped>
    ...
    .c-btnMenu_text .text{
        ...
        letter-spacing:  .02em;
        color: #7a625b;
        transition: .3s cubic-bezier(0,0,.38,2) transform,.2s ease opacity,.4s ease color;
    ...
    .c-btnMenu_front{  
        ...
        transition: .4s ease opacity,.3s cubic-bezier(0,0,.38,3) transform;
    }
    /*漢堡線*/
